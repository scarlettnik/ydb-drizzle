...
export interface YdbColumnFamilyOptions {
  readonly data?: YdbColumnFamilyData;
  readonly compression?: YdbColumnFamilyCompression;
...
export function ttl(
  ...
  const actions = typeof intervalOrActions === "string"
...
export function columnFamily(name: string, options?: YdbColumnFamilyOptions): YdbColumnFamilyBuilder {
